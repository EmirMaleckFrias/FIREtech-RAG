...
| Fragmentos por documento | Sin tope: la ingesta lee el fichero, encola los fragmentos y los embebe en acciones encadenadas hasta terminar, enseñando el avance (fase, hecho de total, tiempo que falta) en la ficha. Fragmentos de unos 400 tokens con solape de 60; texto por fragmento recortado a 8000 caracteres. |
